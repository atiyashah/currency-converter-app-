...
console.log(chalk.bold.rgb(204, 204, 204)(`<<<==========>>>  ${chalk.bold.hex('#9999FF')('Welcome To \'Atiya Shah\' - Currency Converter')}  <<<===========>>>`));
console.log(chalk.bold.rgb(204, 204, 204)(`\t\t <<<*******************************************>>>\n`));
...
name: "to_currency",
type: "list",
message: chalk.magenta("Select the currency you want to convert into:"),
choices: ["USD $", "EUR £", "JPY ¥", "CAD $", "AUD $", "PKR Rs"],
},
{
name: "amount",
